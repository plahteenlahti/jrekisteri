...
class MembershipsControllerTest < ActionController::TestCase
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post :create, membership: { organization_id: @membership.organization_id, student_id: @membership.student_id }
    end
  ...
  test "should update membership" do
    patch :update, id: @membership, membership: { organization_id: @membership.organization_id, student_id: @membership.student_id }
    assert_redirected_to membership_path(assigns(:membership))
  end
